...
desc 'Generate documentation for the product_options extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ProductOptionsExtension'
...
desc 'Test the product_options extension.'
...
namespace :test do
  desc 'Functional test the product_options extension.'
  ...
  desc 'Unit test the product_options extension.'
